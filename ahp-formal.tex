...
having $N$ levels. Weights for intermediate levels and the root are predefined, i.e. we have a set
$\fnmsetind
...
\textit{AHP} algorithm which enables to make an assessment using weights of 2 intermediate levels:
%TODO: AHP, reference
