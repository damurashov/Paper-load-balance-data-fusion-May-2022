\begin{abstract}
    Apart from the increased amount of data being transferred, modern networks are characterized by high complexity of their topology.
    ...
    There exists a good portion of algorithms which enable handle this problem.
    ...
    Decisions made on this level fuse into local-level decision making performed by individual agents (network nodes), thus enabling separation of responsibilities in terms of scope thus allowing to fit the process of load balancing taking states of the network's partcular parts into consideration.
